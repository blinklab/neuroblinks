function varargout = OneTrialAnaWindow_behOnly(varargin)
% ONETRIALANAWINDOW_BEHONLY MATLAB code for OneTrialAnaWindow_behOnly.fig
%      ONETRIALANAWINDOW_BEHONLY, by itself, creates a new ONETRIALANAWINDOW_BEHONLY or raises the existing
%      singleton*.
%
%      H = ONETRIALANAWINDOW_BEHONLY returns the handle to a new ONETRIALANAWINDOW_BEHONLY or the handle to
%      the existing singleton*.
%
%      ONETRIALANAWINDOW_BEHONLY('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ONETRIALANAWINDOW_BEHONLY.M with the given input arguments.
%
%      ONETRIALANAWINDOW_BEHONLY('Property','Value',...) creates a new ONETRIALANAWINDOW_BEHONLY or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before OneTrialAnaWindow_behOnly_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to OneTrialAnaWindow_behOnly_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help OneTrialAnaWindow_behOnly

% Last Modified by GUIDE v2.5 14-Nov-2015 14:51:05

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @OneTrialAnaWindow_behOnly_OpeningFcn, ...
    'gui_OutputFcn',  @OneTrialAnaWindow_behOnly_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before OneTrialAnaWindow_behOnly is made visible.
function OneTrialAnaWindow_behOnly_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to OneTrialAnaWindow_behOnly (see VARARGIN)

% Choose default command line output for OneTrialAnaWindow_behOnly
...
% UIWAIT makes OneTrialAnaWindow_behOnly wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = OneTrialAnaWindow_behOnly_OutputFcn(hObject, eventdata, handles)
